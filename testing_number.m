...
load number_question_feature.mat
load validation_image_id_in_image.mat
load number_question_id_in_question.mat
load number_image_id_in_question.mat
...
for i = 1:28135
    ...
    for j = 1:vali_ans_num
        ...
        for k = 1:10
            true_answer = vali_answer_modified{k,(find(a_q_id == q_q_id(i)))};
